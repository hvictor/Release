...
bool ZEDStereoSensorDriver::openCamera()
{
	...
	Configuration::getInstance()->zedHardwareParameters.cameraMatrix_L.at<float>(0,2) = _param_L.cx / 3.0;	// Cx
	...
	Configuration::getInstance()->zedHardwareParameters.cameraMatrix_L.at<float>(1,2) = _param_L.cy / 3.0;	// Cy
